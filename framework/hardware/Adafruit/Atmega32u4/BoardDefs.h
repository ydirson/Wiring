...
const static uint8_t pinB0 = 2; // PCINT0
const static uint8_t pinB1 = 3; // PCINT1
const static uint8_t pinB2 = 4; // PCINT2
const static uint8_t pinB3 = 5; // PCINT3
...
/* 14 = GND */
/* 15 = GND */
const static uint8_t pinB4 = 16; // PCINT4
const static uint8_t pinB5 = 17; // PCINT5
const static uint8_t pinB6 = 18; // PCINT6
const static uint8_t pinB7 = 19; // PCINT7
